...
## config
dataset = "options-server"
initial_model_type = "gradient boosting"
optimization_type = "linearmax"
...
file1 = open("results/{0}_{1}_{2}/time".format(dataset, initial_model_type, optimization_type), "w+")
file1.write("{0} seconds\n".format(elapsed))
file1.close()
